...
/////////////////////////////////////////
//OBJECTS-------------------------------------------------------------------->
let building = {Norton: ["", 11, 12, 13, 14, 15, 16, 17, 20,
...
let nortonRooms = building.Norton;
let carverRooms = building.Carver;
let rankinRooms = building.Rankin;
let libraryRooms = building.Library;
let cookRooms = building.Cook;
let problem = {Projector: ["Is the light green?", "Is there a blue screen?", "Is the projector on?"],
...
let nortonComputer = {11: "This room does not come equipped with a computer. If you are having trouble with your seminary issued computer, please contact the help desk at x4006 during working hours.",
...
let nortonPower = {11: "This room does not support large-scale power usage. The plates on the wall are the only sources of power.",
...
let nortonPlayDisc = {11: "There is no native disc playback in this room. If you'd like to play a DVD or Blu Ray disc, please contact Classroom Technology to borrow a Blu Ray player of Campus Technology for a loaner laptop. If your device has a DVD player built-in, connect to the Crestron system (preferably through the HDMI) and insert the disc."}
let nortonAdapter = {11: "This room has HDMI and VGA video inputs. If your device does not have built-in capabilities with these cables, please see Classroom Technology for an adapter."}
let nortonAppleTV = {11: "The Apple TV in this room is mounted above the projector. The projector often will turn on and default to the Apple TV input. Follow the instructions on the screen to connect. If the Apple TV is unresponsive, uplug the power cord from the back, wait a few seconds, and reinsert.",
...
let nortonSmartBoard = {11: "There is no smart board technology in this room.",
